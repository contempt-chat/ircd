...
#define ERR_JOINNEEDSASLAUTH 477
...
#define ERR_MSGNEEDSASLAUTH  486
...
#ifdef WHOISTLS
#ifdef RPL_WHOISEXTRA
#define RPL_WHOISTLS         RPL_WHOISEXTRA
#else
#define RPL_WHOISTLS         320 /* client is connected with SSL/TLS - non-standard use of 320 -- mh 2020-04-27 */
#endif
#endif
